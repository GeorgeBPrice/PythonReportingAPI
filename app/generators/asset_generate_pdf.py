...
def generate_asset_report_pdf(data, output_format="pdf", output_dir="temp_reports"):
    """
    Generate a PDF file for the asset report using Quarto.

    Args:
        data (dict): The report data to render in the report.
        output_format (str): The desired output format (default: "pdf").
